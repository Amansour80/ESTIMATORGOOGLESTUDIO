...
interface LogOtherCostModalProps {
  projectId: string;
...
export function LogOtherCostModal({ projectId, organizationId, activities, onClose, onSuccess }: LogOtherCostModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error creating other cost entry:', error);
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-slate-900">Log Other Costs</h2>
              <p className="text-sm text-slate-600">Record miscellaneous expenses</p>
            </div>
          </div>
          <button
            onClick={onClose}
