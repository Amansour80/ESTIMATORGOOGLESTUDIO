...
import { X, Box, DollarSign } from 'lucide-react';
import { createActualCost, createAssetCostEntry } from '../../utils/budgetDatabase';
...
interface LogAssetCostModalProps {
  projectId: string;
  activities: Activity[];
  onClose: () => void;
  onSuccess: () => void;
...
export function LogAssetCostModal({ projectId, activities, onClose, onSuccess }: LogAssetCostModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.asset_name || !formData.activity_id || !formData.unit) {
    ...
    try {
      ...
      const actualCost = await createActualCost({
        ...
        cost_type: 'asset',
        description: formData.description || `${formData.asset_name} - ${formData.quantity} ${formData.unit}`,
      ...
      console.error('Error creating asset cost entry:', error);
      alert('Failed to create asset cost entry');
    } finally {
      setLoading(false);
    }
  };
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="sticky top-0 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-slate-900">Log Asset Costs</h2>
              <p className="text-sm text-slate-600">Record asset purchases and equipment expenses</p>
            </div>
          </div>
          <button
            onClick={onClose}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="e.g., HVAC Unit, Chiller, Boiler"
                required
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                placeholder="Serial numbers separated by commas"
              />
            </div>
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                rows={2}
                placeholder="Additional details about the asset purchase..."
              />
            </div>
