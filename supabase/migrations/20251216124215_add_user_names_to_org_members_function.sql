/*
  # Add User Names to Organization Members Function

  1. Purpose
    - Add first_name and last_name to get_organization_members_with_emails function
    - Display user full names instead of just emails
    
  2. Changes
    - Drop and recreate function with updated return type
    - Include first_name, last_name from user_profiles
*/

-- Drop existing function
DROP FUNCTION IF EXISTS public.get_organization_members_with_emails(uuid);

-- Recreate with user profile fields
