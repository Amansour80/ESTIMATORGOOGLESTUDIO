/*
  # Integrate Notifications with Approval Workflow (Fixed)

  ## Updates
  - Drop and recreate notify_approvers_at_node function
  - Update process_approval_action to create notifications
*/
...
-- Recreate notify_approvers_at_node to create notifications
