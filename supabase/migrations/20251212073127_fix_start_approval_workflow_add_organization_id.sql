/*
  # Fix start_approval_workflow - Add organization_id
  
  1. Problem
    - organization_id is required in project_approvals but not being set
  
  2. Solution
    - Add organization_id to the INSERT statement
*/
...
BEGIN
  ...
  -- Create approval record with organization_id
